                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Mandlenkosi Marwanqana Dev Portfolio'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
                ...
                >
                    <div style={styles.startPopup}>
                        ...
                        <p>
                            ...
                            , therefore you cannnot access this site
                        </p>
                        <div style={styles.spacer} />
                        <p>
                            My apologies, this browser has a bug
                        </p>
